...
/*   Updated: 2023/12/20 18:12:58 by polenyc          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	// size_f += printf("%i", -2147483648);
	// size_p += printf("%s", ft_sprintf("|>------------<%11c>------------<|\n", 0));
	
	// size_p += printf("%s", ft_sprintf("|%%%c%%%s%%%d%%%i%%%u%%%x%%%X%%%% %%%c%%%s%%%d%%%i%%%u%%%x%%%X%%%%%%%c%%%s%%%d%%%i%%%u%%%x%%%X%%%% %c%%|\n", 'A', "42", 42, 42 ,42 , 42, 42, 'B', "-42", -42, -42,-42 ,-42, 42, 'C', "0", 0, 0 ,0 ,0, 42, 0));
	// size_f += ft_printf("%s", ft_sprintf("|%%%c%%%s%%%d%%%i%%%u%%%x%%%X%%%% %%%c%%%s%%%d%%%i%%%u%%%x%%%X%%%%%%%c%%%s%%%d%%%i%%%u%%%x%%%X%%%% %c%%|\n", 'A', "42", 42, 42 ,42 , 42, 42, 'B', "-42", -42, -42,-42 ,-42, 42, 'C', "0", 0, 0 ,0 ,0, 42, 0));
	
	size_f += ft_printf("|>------------<|%0#60x|>------------<|\n", -726773033);
	size_p += printf("|>------------<|%0#60x|>------------<|\n", -726773033);
	
	size_f += ft_printf("|>------------<|%0 18.56d|>------------<|\n", 0);
	size_p += printf("|>------------<|%0 18.56d|>------------<|\n", 0);
	
	size_f += ft_printf("|>------------<!^.^/%10s^.^/!>------------<|\n", 0);
	size_p += printf("|>------------<!^.^/%10s^.^/!>------------<|\n", 0);
	
	size_f += ft_printf("|>------------<!^.^/%39.2s^.^/!>------------<|\n", 0);
	size_p += printf("|>------------<!^.^/%39.2s^.^/!>------------<|\n", 0);
	
	size_f += ft_printf("|>------------<!42%-6c42!>------------<|\n", 0);
	size_p += printf("|>------------<!42%-6c42!>------------<|\n", 0);
	
	size_f += ft_printf("|>------------<%11c>------------<|\n", 0);
	size_p += printf("|>------------<%11c>------------<|\n", 0);

	size_f += ft_printf("%s", ft_sprintf("|>------------<%11c>------------<|\n", 0));
	size_p += printf("%s", ft_sprintf("|>------------<%11c>------------<|\n", 0));

	size_f += ft_printf("|>------------<!%19c!>------------<|\n", 0);
	size_p += printf("|>------------<!%19c!>------------<|\n", 0);

	size_f += ft_printf("|>------------<!42%60c42!>------------<|\n", 0);
	size_p += printf("|>------------<!42%60c42!>------------<|\n", 0);
